...
const timelineData: TimelineItemData[] = [
  {
    id: "prof-exp-1",
    title: "Web Developer | Exprovia",
    type: "Full-time",
    duration: "03.2025—Present",
    icon: Code,
    responsibilities: [
      "Lead development of complex Plugin Development With PHP.",
      "Architect scalable frontend solutions using Elementor and modern tooling.",
      "Mentor junior developers and conduct Design reviews.",
      "Collaborate with Marketing Team and Custom Widget Building based on requirement.",
    ],
    skills: ["WordPress", "Elementor", "JetEngine", "Tailwind CSS", "Plugin Development"],
  },
  {
    id: "prof-exp-2",
    title: "Freelanching | freelancer.com",
    type: "Part-time",
    duration: "02.2022 - 05.2023",
    icon: Palette,
    responsibilities: [
      "High-quality standards WordPress Website.",
    ...
    skills: ["Creativity", "WordPress", "Elementor", "Plugin Development"],
  },
//   {
//     id: "prof-exp-3",
...
export default function TimelinePage2() {
  return (
    <div id="education" className="transition-colors duration-300">
